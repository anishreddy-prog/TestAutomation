...
public class ChromeAssign4 {
	...
	public ChromeAssign4(WebDriver oBrowser)		//parameterized constructor//interface class//object reference
	{
	...
	private WebElement addmodificustomer;
	
	public WebElement getaddmodificustomer()
	{
		return addmodificustomer;
	}
	
	
	
	@FindBy(xpath="//*[@id='taskListBlock']/div[2]/div[1]/div[1]")
	private WebElement closemodificustomer;
	
	public WebElement getclosemodificustomer()
	{
		return closemodificustomer;
	}
